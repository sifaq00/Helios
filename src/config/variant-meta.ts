...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    title: 'Helios - Real-Time Global Intelligence Dashboard',
    ...
    url: 'https://helios.app/dashboard',
    siteName: 'Helios',
    shortName: 'Helios',
  ...
  tech: {
    title: 'Helios Tech - Real-Time AI & Tech Industry Dashboard',
    ...
    url: 'https://tech.helios.app/dashboard',
    siteName: 'Helios',
    shortName: 'Helios',
  ...
  happy: {
    title: 'Helios Happy - Good News & Global Progress',
    ...
    url: 'https://happy.helios.app/dashboard',
    siteName: 'Helios',
    shortName: 'Helios',
  ...
  finance: {
    title: 'Helios Finance - Real-Time Markets & Trading Dashboard',
    ...
    url: 'https://finance.helios.app/dashboard',
    siteName: 'Helios',
    shortName: 'Helios',
  ...
  commodity: {
    title: 'Helios Commodity - Real-Time Commodity Markets & Supply Chain Dashboard',
    ...
    url: 'https://commodity.helios.app/dashboard',
    siteName: 'Helios',
    shortName: 'Helios',
  ...
  energy: {
    title: 'Helios Energy - Real-Time Global Energy Intelligence Dashboard',
    ...
    url: 'https://energy.helios.app/dashboard',
    siteName: 'Helios',
    shortName: 'Helios',
