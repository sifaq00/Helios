    ...
    setTrustedHtml(this.ctx.container, trustedHtml(`
      ...
      <div class="header" role="banner">
        ...
        return `
          ...
          <span class="logo">HELIOS</span><span class="logo-mobile">Helios</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
          <a href="https://github.com/sifaq00/Helios" target="_blank" rel="noopener" class="github-link" title="${t('header.viewOnGitHub')}" aria-label="${t('header.viewOnGitHub')}">
      ...
      <nav class="mobile-menu" id="mobileMenu" aria-label="Menu">
        <div class="mobile-menu-header">
          <span class="mobile-menu-title">HELIOS</span>
        ...
        <a class="mobile-menu-item" href="https://github.com/sifaq00/Helios" target="_blank" rel="noopener">
      ...
      <footer class="site-footer">
        <div class="site-footer-brand">
          ...
          <div class="site-footer-brand-text">
            <span class="site-footer-name">HELIOS</span>
            <span class="site-footer-sub">v${__APP_VERSION__}</span>
          </div>
        </div>
        <nav aria-label="Helios references">
          ${referenceLinksHtml}
          ${this.ctx.isDesktopApp ? '' : `<span id="footerDownloadMount"></span>`}
        </nav>
        <span class="site-footer-copy">&copy; ${new Date().getFullYear()} Helios</span>
      </footer>
