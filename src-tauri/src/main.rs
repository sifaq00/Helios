...
const KEYRING_SERVICE: &str = "helios";
...
fn build_app_menu(handle: &AppHandle) -> tauri::Result<Menu<tauri::Wry>> {
    ...
    let about_metadata = AboutMetadata {
        ...
        copyright: Some("\u{00a9} 2026 Helios".into()),
        license: Some("AGPL-3.0-only".into()),
        credits: Some(
            "Licensed under AGPL-3.0-only.\nThird-party notices: resources/notices/THIRD-PARTY-NOTICES.md\nSource: https://github.com/sifaq00/Helios"
                .into(),
        ),
        website: Some("https://github.com/sifaq00/Helios".into()),
        website_label: Some("Helios".into()),
        ..Default::default()
    };
    let about_item =
...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .expect("error while running helios tauri application")
        .run(|app, event| {
            match &event {
